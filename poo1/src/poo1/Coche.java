...
public class Coche {
    ...
    public Coche() {
        // En los constructores vacíos para un int devuelve un 0 y para un String
        // devuelve un NULL.
     ...
     * 
     * @return Cadena "Nuevo" si es mayor o igual al 2000 y "Viejo" si es menor al
     *         año 2000
     */
...
//        }
        return (this.anyo >= 2000) ? "Nuevo"
                : (this.anyo > 0 && this.anyo < 2000) ? "Viejo" : "Este coche no tiene especificado el año";
    }

    /**
     * Método que me devuelve true si el coche ya ha hecho el rodado.
...
//            return false;
//        }
        return this.kms > 10000 ? true : false;
        //return this.kms > 10000; La condición ya devuelve un true o false por si sola
    }
