...
public class Ejercicios {
	...
	private static void iniciacion() { // Para hacer métodos y separar la info
		...
		System.out.println("La suma da: " + (numero1 + num2)); // Para que no se concatene debemos poner el resultado
																// entre parentesis.
	...
	private static void ejemplosConversiones() {
		...
		System.out.println("" + prefijo + telefono); // concatena porque le metes un string vacío por ende todo pasa a
														// ser string
		...
		System.out.println("El numero que usted introdujo sumando 5 da: " + (Integer.parseInt(valor1) + 5)); // cadena a numero
		System.out.println("El numero que usted introdujo sumando 5 da: " + (Integer.valueOf(valor1) + 5)); //numero a cadena
	...
	private static void ejemplosComparaciones() {
		...
		// System.out.println(login.toLowerCase().equals(loginUsuario.toLowerCase()));
		// // 1ª alternativa
		 ...
		 * String datosUsuario = loginUsuario + " " + passwordUsuario; // Concatenar
		 * cadenas
		 * String datosUsuario2 = loginUsuario.concat(passwordUsuario); // Concatenar
		 * cadenas
	...
	private static void ejercicio3() {
		...
		System.out.println(password.equals(contraUsuario));
		System.out.println(password.equalsIgnoreCase(contraUsuario));
		sc.close(); // siempre cerrar scanner por errores
	}
	...
	private static void ejercicio4() {
		...
		System.out.println("" + num1 + num2 + num3 + num4); // Esto es lo mismo que lo de arriba pero mas simple, esto
															// CONCATENA, NO SUMA NUMEROS
	...
	private static void ejercicio7() {
		...
		char c1 = 'b', c2 = 'k'; //los char siempre van en comillas simples
		System.out.println("'" + c1 + "' tiene la posicion " + (int) c1); // poniendo el INT adelante, convertimos la
																			// letra en numero
	...
	private static void ejercicio8() {
		...
		int c;
		b = ++a; // imprime 6
		c = a++; // imprime 6 y luego incrementa 1. a=7
		b = b * 5; // 6x5 = 30
		a = a * 2; // 7x2 = 14
	...
	private static void ejercicio14() {
		...
		int edad = sc.nextInt();
		System.out.println("Dentro de 15 años tendrás: " + (edad + 15) + " años :) ");
		sc.close();
