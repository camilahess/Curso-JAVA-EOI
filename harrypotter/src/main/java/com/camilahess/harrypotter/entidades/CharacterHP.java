...
public class CharacterHP implements Serializable {
	...
	private transient LocalDate dateOfBirthLD; // transient, tipo de dato transitorio, no se almacena
	...
	public CharacterHP(String id, String name, List<String> alternate_names, String species, String gender,
			String house, String dateOfBirth, LocalDate dateOfBirthLD, Integer yearOfBirth, Boolean wizard,
	...
	public CharacterHP(String id, String name, List<String> alternate_names, String species, String gender,
			String house, String dateOfBirth, Integer yearOfBirth, Boolean wizard, String ancestry, String eyeColour,
	...
	public String toString() {
		return "CharacterHP [id=" + id + ", name=" + name + ", alternate_names=" + alternate_names + ", species="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CharacterHP other = (CharacterHP) obj;
